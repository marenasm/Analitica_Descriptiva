...
def test_01():
    """Test 01."""
    conn, _ = load_data()
    with open("homework/pregunta_01.sql", encoding="utf-8") as file:
        query = file.read()
...
def test_02():
    """Test 02."""
    conn, _ = load_data()
    with open("homework/pregunta_02.sql", encoding="utf-8") as file:
        query = file.read()
...
def test_03():
    """Test 03."""
    conn, _ = load_data()
    with open("homework/pregunta_03.sql", encoding="utf-8") as file:
        query = file.read()
    print(pd.read_sql_query(query, conn).to_dict())
    assert pd.read_sql_query(query, conn).to_dict() == {
...
def test_04():
    """Test 04."""
    conn, _ = load_data()
    with open("homework/pregunta_04.sql", encoding="utf-8") as file:
        query = file.read()
    print(pd.read_sql_query(query, conn).to_dict())
    assert pd.read_sql_query(query, conn).to_dict() == {
        "K0": {0: "E", 1: "B", 2: "C"},
...
def test_05():
    """Test 05."""
    conn, _ = load_data()
    with open("homework/pregunta_05.sql", encoding="utf-8") as file:
        query = file.read()
    print(pd.read_sql_query(query, conn).to_dict())
    assert pd.read_sql_query(query, conn).to_dict() == {
        "K0": {0: "B", 1: "C", 2: "D", 3: "G"},
...
def test_06():
    """Test 06."""
    conn, _ = load_data()
    with open("homework/pregunta_06.sql", encoding="utf-8") as file:
        query = file.read()
    print(pd.read_sql_query(query, conn).to_dict())
    assert pd.read_sql_query(query, conn).to_dict() == {
        "K0": {
...
def test_07():
    """Test 07."""
    conn, _ = load_data()
    with open("homework/pregunta_07.sql", encoding="utf-8") as file:
        query = file.read()
    print(pd.read_sql_query(query, conn).to_dict())
    assert pd.read_sql_query(query, conn).to_dict() == {
        "K0": {
...
def test_09():
    """Test 09."""
    conn, _ = load_data()
    with open("homework/pregunta_09.sql", encoding="utf-8") as file:
        query = file.read()
    print(pd.read_sql_query(query, conn).to_dict())
    assert pd.read_sql_query(query, conn).to_dict() == {
        "K1": {0: 29},
